...
with open("authors.json", "r", encoding="utf-8") as jfile:
    authors_json = json.load(jfile)
...
with open("quotes.json", "r", encoding="utf-8") as jfile:
    quotes_json  = json.load(jfile)
