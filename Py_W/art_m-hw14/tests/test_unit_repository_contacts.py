...
class TestContacts(unittest.IsolatedAsyncioTestCase):
    ...
    def setUp(self):
        ...
        self.fake_user = Contact(
            id=1, first_name='Peter', last_name='Doe', birthday='1988-02-10',
            email='peter@doe.com', phone='0671234567', other_info='test',
            created_at='2020-02-10', updated_at='2020-02-10')
    ...
    async def test_create_contact(self):
        body = ContactResponse(id=1, first_name='Peter', last_name='Doe', birthday='1988-02-10',
                               email='peter@doe.com', phone='0671234567', other_info='test',
                               created_at='2020-02-10', updated_at='2020-02-10')
    ...
    async def test_update_contact(self):
        body = Contact(id=1, first_name='Peter', last_name='Doe', birthday='1988-02-10',
                               email='peter@doe.com', phone='0671234567', other_info='test')
    ...
    async def test_get_birthdays_one_week(self):
        contacts = [Contact(id=1, first_name='Peter', last_name='Doe', birthday='1988-05-10')]
        contacts_birthday = [BirthdayResponse(id=1, first_name='Peter', last_name='Doe', birthday='1988-05-10')]
