...
def arch_count():
    ...
    try:
        for p in pathlib.Path(f"{path_for_count}/Archives").iterdir():
            if p.is_file():
                count += 1
        print(f"Sorted Archives: {count}")
    except FileNotFoundError: print(f"Sorted Archives: {count}")
...
def audio_count():
    ...
    try:
        for p in pathlib.Path(f"{path_for_count}/Audio").iterdir():
            if p.is_file():
                count += 1
        print(f"Sorted Audio files: {count}")
    except FileNotFoundError: print(f"Sorted Audio files: {count}")
...
def doc_count():
    ...
    try:
        for p in pathlib.Path(f"{path_for_count}/Documents").iterdir():
            if p.is_file():
                count += 1
        print(f"Sorted Documents: {count}")
    except FileNotFoundError: print(f"Sorted Documents: {count}")
...
def images_count():
    ...
    try:
        for p in pathlib.Path(f"{path_for_count}/Images").iterdir():
            if p.is_file():
                count += 1
        print(f"Sorted Images: {count}")
    except FileNotFoundError: print(f"Sorted Images: {count}")
...
def program_count():
    ...
    try:
        for p in pathlib.Path(f"{path_for_count}/Programming").iterdir():
            if p.is_file():
                count += 1
        print(f"Sorted Programs files: {count}")
    except FileNotFoundError: print(f"Sorted Program files: {count}")
...
def text_count():
    ...
    try:
        for p in pathlib.Path(f"{path_for_count}/Text").iterdir():
            if p.is_file():
                count += 1
        print(f"Sorted Text files: {count}")
    except FileNotFoundError: print(f"Sorted Text files: {count}")
...
def unknown_count():
    ...
    try:
        for p in pathlib.Path(f"{path_for_count}/Unknown").iterdir():
            if p.is_file():
                count += 1
        print(f"Sorted Unknown files: {count}")
    except FileNotFoundError: print(f"Sorted Unknown files: {count}")
...
def video_count():
    ...
    try:
        for p in pathlib.Path(f"{path_for_count}/Videos").iterdir():
            if p.is_file():
                count += 1
        print(f"Sorted Video files: {count}")
    except FileNotFoundError: print(f"Sorted Video files: {count}")
...
def counter():
    ...
    unknown_count()
    video_count()
    print(f"Deleted directories: {deleted_dir}")
